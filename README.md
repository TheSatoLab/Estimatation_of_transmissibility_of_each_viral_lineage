...
![\boldsymbol{Y_t}\textasciitildeMultinomial(N_t,\boldsymbol{\theta_t})](https://latex.codecogs.com/gif.latex?\boldsymbol{Y_t}\textasciitildeMultinomial(N_t,\boldsymbol{\theta_t}))  
